...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --base-path)   SERVER_BASE_PATH="$2"; shift 2 ;;
...
export _REMOTE_USER _REMOTE_USER_HOME PORT HOST CONNECTION_TOKEN SERVER_BASE_PATH EXTENSIONS
